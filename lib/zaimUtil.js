...
*/
    ...
    function _Url_for_getLastMoney(limitNum, page) {
        return money_url + '?' + querystring.stringify({
            mapping: 1,
            order: 'id',
            page: page,
    ...
    */
    ...
    function getLastMoney(cntxt) {
        const limitNum = 100,
            url = _Url_for_getLastMoney.bind(null, limitNum);
    ...
    function makeZaim(params) {
        ...
        return Object.assign(selfIF, {
            ...
            getLastMoney: getLastMoney.bind(null, cntxt),
